...
class TiXmlBase
{
	...
	*/
	  static void EncodeString (const TIXML_STRING & str,
				    TIXML_STRING * out);
...
#      ifdef TIXML_USE_STL
	  static bool StreamWhiteSpace (std::istream * in,
					TIXML_STRING * tag);
	...
	*/
	  ...
	  TiXmlDocument *GetDocument ()
	  {
		    return const_cast <
			      TiXmlDocument *
			      >((const_cast <
				 const TiXmlNode * >(this))->GetDocument ());
	  }
...
#      ifdef TIXML_USE_STL
	  ...
	  TiXmlAttribute (const std::string & _name,
...
#      endif
	  ...
	  TiXmlAttribute *Next ()
	  {
		    return const_cast <
			      TiXmlAttribute *
			      >((const_cast <
				 const TiXmlAttribute * >(this))->Next ());
	  }
...
class TiXmlComment:public TiXmlNode
{
	public:
	  ...
	  TiXmlComment (const char
			*_value):TiXmlNode (TiXmlNode::TINYXML_COMMENT)
	  {
		    SetValue (_value);
	  }
...
class TiXmlText:public TiXmlNode
{
	...
	*/
	    TiXmlText (const char
		       *initValue):TiXmlNode (TiXmlNode::TINYXML_TEXT)
	  {
		    SetValue (initValue);
		    cdata = false;
	  }
...
#      ifdef TIXML_USE_STL
	  /// Constructor.
	  TiXmlText (const std::
		     string & initValue):TiXmlNode (TiXmlNode::TINYXML_TEXT)
	  {
		    SetValue (initValue);
		    cdata = false;
	  }
#      endif
	  ...
	  TiXmlText (const TiXmlText &
		     copy):TiXmlNode (TiXmlNode::TINYXML_TEXT)
	  {
		    copy.CopyTo (this);
	  }
...
class TiXmlUnknown:public TiXmlNode
{
	public:
	  ...
	  TiXmlUnknown (const TiXmlUnknown &
			copy):TiXmlNode (TiXmlNode::TINYXML_UNKNOWN)
	  {
		    copy.CopyTo (this);
	  }
...
#      endif
	...
	*/
	  ...
	  {
		    return ((node
			     && node->ToElement ())? node->ToElement () : 0);
	  }
